    ...
    <div class="row" style="padding-top: 1px;">
        <div class="col-lg-5">
            ...
            <div class="top-campaign" style="padding-bottom: 30px !important;">
                <h3 class="title-3 m-b-30">Thẻ cào</h3>
                ...
                <div class="card-body card-block" style="padding: 10px 0px 1px !important;">
                    ...
                    <div class="has-danger has-feedback form-group">
                        <button onClick="request();" class="btn btn-info btn-sm" style="padding: 8px 22px;">Gửi yêu cầu</button>
                    </div>
            ...
            success: function (result) {
                ...
                for (var i = 0; i < jsonData.List.length; i++) {
                    ...
                    if ($('#table_transaction_history tbody #' + counter.ID).length) {
                        ...
                        $html += '    <td style="padding-top: 17px;">' + counter.Code + '</td>';
                        $html += '    <td style="padding-top: 17px;">' + counter.Serial + '</td>';
            ...
            success: function (result) {
                ...
                if (obj.Status == 0) {
                    ...
                    if (obj.Status == 3) {
                        ...
                        message = "Hết thẻ, hãy thử lại với mệnh giá khác.";
                    } else {
