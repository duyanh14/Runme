    ...
    <div class="row" style="padding-top: 1px;">
        <div class="col-lg-5">
            ...
            <div class="top-campaign" style="padding-bottom: 30px !important;">
                <h3 class="title-3 m-b-30">T.bao di động trả sau</h3>
...
<script>
    ...
    function history_load() {
        ...
        $.ajax({
            url: "./Payment/PostpaidMobile/History",
            type: "post",
            data: data,
            success: function (result) {
                ...
                for (var i = 0; i < jsonData.List.length; i++) {
                    ...
                    if ($('#table_transaction_history tbody #' + counter.ID).length) {
                        ...
                        $('#table_transaction_history tbody #' + counter.ID + " #status").attr('style', 'color:' + $status_color);
                        ...
                        $html += '<td id="status" style="color:' + $status_color + '">' + $status + '</td>';
    ...
    function run(id) {
        ...
        $.ajax({
            url: "./Payment/PostpaidMobile/Run",
            type: "post",
            data: data,
            success: function (result) {
    ...
    function note(id, thiz) {
        ...
        $.ajax({
            url: "./Payment/PostpaidMobile/Note",
            type: "post",
            data: data,
            success: function (result) {
    ...
    function add() {
        ...
        $.ajax({
            url: "./Payment/PostpaidMobile/Request",
            type: "post",
            data: data,
            success: function (result) {
                var obj = JSON.parse(result);
